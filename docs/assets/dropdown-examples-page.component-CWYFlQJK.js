...
`,m=class{examples={simple:{html:o},manual:{html:s,typescript:a},buttonGroups:{html:c},disabledItems:{html:l,typescript:n},form:{html:u,typescript:r},body:{html:d},navbar:{html:f},global:{html:p,typescript:i}}};m=t([e({selector:`docs-dropdown-examples-page`,controllerAs:`$`,templateUrl:`/ngb-js-docs/templates/dropdown-examples-page.component-f2188cb0.html`,styleUrl:`./dropdown-examples-page.component.css`})],m);export{m as DropdownExamplesPageComponent};