...
`,d=class{examples={simple:{html:o},closeable:{html:s,typescript:n},selfClosing:{html:c,typescript:a},custom:{html:l,css:r},global:{html:u,typescript:i}}};d=t([e({selector:`docs-alert-examples-page`,controllerAs:`$`,templateUrl:`/ngb-js-docs/templates/alert-examples-page.component-a5937eb9.html`,styleUrl:`./alert-examples-page.component.css`})],d);export{d as AlertExamplesPageComponent};