import{d as e,f as t}from"./index-B9XAkpig.js";var n=`<nav
    ngb-nav
    ng-ref="example.nav"
    ng-ref-read="ngbNav"
...
`,m=`import { Component, ViewChild } from "ngjs-core";
...
`,y=class{examples={simple:{html:h,typescript:g},alternative:{html:n,typescript:r},vertical:{html:_,typescript:v},selecting:{html:p,typescript:m},keepContent:{html:l,typescript:u},dynamic:{html:s,typescript:c},custom:{html:a,typescript:o,css:i},global:{html:d,typescript:f}}};y=e([t({selector:`docs-nav-examples-page`,controllerAs:`$`,templateUrl:`/ngb-js-docs/templates/nav-examples-page.component-b5737f31.html`,styleUrl:`./nav-examples-page.component.css`})],y);export{y as NavExamplesPageComponent};