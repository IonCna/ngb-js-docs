...
<p class="small text-body-secondary mt-3 mb-0">From <code>{{ example.fromDate | json }}</code> to <code>{{ example.toDate | json }}</code></p>\r
`,P=class{examples={basic:{html:a,typescript:i},popup:{html:T,typescript:w},multiple:{html:C,typescript:S},range:{html:A,typescript:k,css:O},rangePopup:{html:N,typescript:M,css:j},disabled:{html:p,typescript:f},adapter:{html:r,typescript:n},i18n:{html:y,typescript:v},customDay:{html:c,typescript:s,css:o},customMonth:{html:d,typescript:u,css:l},footer:{html:h,typescript:m},position:{html:D,typescript:E},keyboard:{html:x,typescript:b},global:{html:_,typescript:g}}};P=t([e({selector:`docs-datepicker-examples-page`,controllerAs:`$`,templateUrl:`/ngb-js-docs/templates/datepicker-examples-page.component-e5747e2f.html`,styleUrl:`./datepicker-examples-page.component.css`})],P);export{P as DatepickerExamplesPageComponent};