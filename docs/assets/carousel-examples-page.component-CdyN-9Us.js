import{r as e,t}from"./decorate-DwQZkZoC.js";var n=`import { Component, ViewChild } from "ngjs-core";
...
`,c=class{examples={simple:{html:i},keyboard:{html:a},controls:{html:o,typescript:n},global:{html:s,typescript:r}}};c=t([e({selector:`docs-carousel-examples-page`,controllerAs:`$`,templateUrl:`/ngb-js-docs/templates/carousel-examples-page.component-7b8e55b8.html`,styleUrl:`./carousel-examples-page.component.css`})],c);export{c as CarouselExamplesPageComponent};