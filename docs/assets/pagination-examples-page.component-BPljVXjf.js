import{r as e,t}from"./decorate-DwQZkZoC.js";var n=`<div class="vstack gap-4">
    <div>
...
`,g=class{examples={basic:{html:i,typescript:a},advanced:{html:n,typescript:r},custom:{html:o,typescript:s},size:{html:m,typescript:h},alignment:{html:u,typescript:d},disabled:{html:c,typescript:l},global:{html:f,typescript:p}}};g=t([e({selector:`docs-pagination-examples-page`,controllerAs:`$`,templateUrl:`/ngb-js-docs/templates/pagination-examples-page.component-828b4359.html`,styleUrl:`./pagination-examples-page.component.css`})],g);export{g as PaginationExamplesPageComponent};